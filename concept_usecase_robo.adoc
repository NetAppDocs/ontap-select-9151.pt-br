...
[NOTE]
====
Como todas as licenças VMware vSphere são compatíveis, você pode escolher a licença vSphere Remote Office Branch Office Standard ou Advanced em vez da licença Enterprise ou Enterprise Plus.

Todas as licenças vSphere e VSAN são suportadas.
