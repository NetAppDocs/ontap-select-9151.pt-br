...
. Após a implantação da VM, selecione a nova VM. Se ela ainda não estiver ligada de acordo com a sua entrada no assistente de implantação, ligue-a manualmente.
...
.Próximas etapas:
link:task_deploy_cluster.html["Implantar um cluster do ONTAP Select"]
